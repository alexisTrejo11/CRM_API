...
public class CampaignInteractionMappersImpl implements CampaignInteractionMappers {
    ...
    private Long entityCampaignId(CampaignInteractionModel campaignInteractionModel) {
    ...
    private Long entityCustomerId(CampaignInteractionModel campaignInteractionModel) {
        if ( campaignInteractionModel == null ) {
            return null;
        }
